      ...
      <>
       <div className="w-full h-auto border-[2px] border-[#404040] mb-8 py-6 rounded pl-6 flex items-center pr-6">
          ...
          <div class="flex items-center gap-4">
            <a className="rounded bg-gradient-to-r from-amber-700 to-red-500  px-3 py-[5px] text-white text-xs font-semibold" href="/signup">SIGNUP</a>
            <a className="rounded border border-orange-500 hover:bg-gradient-to-r from-amber-700 to-red-500  px-3 py-[5px] text-white text-xs font-semibold" href="/login">LOGIN</a>
          </div>
        </div>
      </>
  )
