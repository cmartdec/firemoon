  ...
  return (
      ...
      <div className="h-[1300px] w-auto flex justify-center">
         <div className="h-screen w-[800px]">
           ...
           <div className="h-[600px] w-[800px] bg-[#212121] rounded-3xl"></div>
           </div>
           <h3 className="text-3xl font-semibold text-gray-200 mt-12">I started Firemoon because I think FIRE community deserves a better platform than Reddit.</h3>
           <h3 className="text-3xl font-semibold text-gray-200 mt-12">If you are interested to see what is the tech stack behind Firemoon - <a className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600" href="/stack">Firemoon's tech stack</a></h3>
           <h3 className="text-2xl font-semibold text-white mt-12">👉 Contact with me via <span><a className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600" href="https://twitter.com/cmartdec">Twitter, </a></span><a className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600" href="">Linkedin </a><span> or </span><span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-600">Email</span></h3>
           </div>
           </div>
           <Footer></Footer>
      </>
